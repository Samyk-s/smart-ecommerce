...
import { CheckoutDialog } from '@/features/cart/components/CheckoutDialog'
import {
  useCartStore,
  selectTotalItems,
  selectTotalPrice,
  ...
  return (
    <>
      <div className="rounded-3xl border border-zinc-200/80 bg-white p-6 shadow-xl shadow-zinc-950/5">
        ...
        <Button
          className="mt-6 h-11 w-full gap-2 bg-black text-base font-semibold text-white hover:bg-black/85"
          size="lg"
